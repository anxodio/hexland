...
class Tile(Widget):
    basesource = ObjectProperty()
    uppersource = ObjectProperty()
    ...
    def __init__(self,**kwargs):
    	...
    	# print baseatlas['tileSand']

        self.gridparent = kwargs['caller']
        self.grid_x = kwargs['grid_x']
        self.grid_y = kwargs['grid_y']
        # self.basesource = "assets/tileSand.png"
        self.basesource = self.gridparent.baseatlas['tileSand']
        self.uppersource = self.gridparent.baseatlas['tileNone']
    ...
    def on_touch_up(self, touch):
        ...
        if touch.pos == touch.opos and self.collide_point(*touch.pos):
            self.basesource = self.gridparent.baseatlas['tileSand']
            self.uppersource = self.gridparent.baseatlas['tileGrass']
            return True
